...
download
      ...
      <span v-if="eventStatus == 1">
        <span class="material-symbols-outlined" @click="ed = !ed"> edit </span>
        <span class="material-symbols-outlined" @click="eventdelete"> delete_forever </span>
      </span>
      <span class="material-symbols-outlined" @click="eventUnSubscribe" v-else-if="eventStatus == 2">
        heart_minus
      </span>
      <span class="material-symbols-outlined" @click="eventSubscribe" v-else> heart_plus </span>
    </div>
    <userItem :user-z="(z+1)" v-for="item in subscribers" :key="item.id" :user-color="item.color" :user-id="item.id" :user-email="item.email" :user-name="item.name"/>
  </span>
  </modal>
</template>
